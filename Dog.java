...
public class Dog extends Tamagotchi {
	...
	public void color() {
		...
		color = (String) JOptionPane.showInputDialog(null, "Veuillez choisir la couleur de sa fourrure puis cliquez sur Ok",
				"COULEUR DU CHIEN", JOptionPane.QUESTION_MESSAGE, null, dogColor, dogColor[0]);
	}
		...
		if (newOtherColor.equals(dogDyeOtherColor[2])) { // If the user choose the color Roux
			...
			if (newOtherColor.equals(this.otherColor)) { // If the user choose the same
				...
				JOptionPane.showMessageDialog(null,
						"La queue de " + name + " est déjà de couleur " + this.otherColor, "TEINDRE LA QUEUE",
	...
	public void eat() {
		if (this.hungry < (this.hungryMax - 1)) { // if the value "hungry" is low enough
			...
			String food = (String) JOptionPane.showInputDialog(null,
					...
					JOptionPane.QUESTION_MESSAGE, null, dogFood, dogFood[0]);
